...
export const programs = [
  {
    ...
    icon: <SiOpenaigym />,
    title: "Martial Arts",
    info: "You can daily visit at our Place. Learn! Martial Arts",
    path: "/programs/111",
  },
  {
    id: 2,
    icon: <SiOpenaigym />,
    title: "Gymnastics",
    info: "We help you in building your body strength and fitness.",
    path: "/programs/222",
  },
  {
    id: 3,
    icon: <SiOpenaigym />,
    title: "Kung Fu",
    info: "We can teach you Professional chinese kung fu karate.",
    path: "/programs/333",
  },
  {
    id: 4,
    icon: <SiOpenaigym />,
    title: "Life Lessons",
    info: "We teach you how to deal with world and different persons.",
    path: "/programs/444",
  },
]
